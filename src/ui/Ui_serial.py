...
class Ui_serialForm(object):
    def setupUi(self, serialForm):
        ...
        self.serialAutoReconnectCheckBox = QtWidgets.QCheckBox(parent=self.serialReceiveAreaGroupBox)
        self.serialAutoReconnectCheckBox.setObjectName("serialAutoReconnectCheckBox")
        self.serialReceiveFormLayout.setWidget(6, QtWidgets.QFormLayout.ItemRole.SpanningRole, self.serialAutoReconnectCheckBox)
    ...
    def retranslateUi(self, serialForm):
        ...
        self.serialAutoReconnectCheckBox.setText(_translate("serialForm", "Auto Reconnect"))
